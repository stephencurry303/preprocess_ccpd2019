...
dir = "C:\CCPD2019\CCPD2019\ccpd_base\\"
...
for names in name_list:
    ...
    AddText = img.copy()
    roi = cv2.putText(AddText, func.getPlateNo(names), (func.getBiggerRec(names)[0], func.getBiggerRec(names)[1]), cv2.FONT_HERSHEY_COMPLEX, 1.0, (0, 0, 255), 2)
